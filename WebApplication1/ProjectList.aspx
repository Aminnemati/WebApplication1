...
<head runat="server">
    ...
    <meta charset="utf-8" />
    <link rel="shortcut icon" href="assets/images/heh.png" />
                ...
                <ul class="nav ace-nav">
                    <li class="light-blue dropdown-modal">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <img class="nav-user-photo" src="assets/images/Amin.jpg" alt="Jason's Photo" />
                            ...
                            <form runat="server">
                                <div class="row">
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <button runat="server" id="btnSearch" class="btn btn-white btn-info btn-bold" onclick="searchBtnClick">
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        <span class="blue bolder">DB-Projects</span>
                        Amin & Naser  2016-2017
                    </span>
                </div>
            </div>
        </div>
